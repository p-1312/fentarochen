...
import { User, Mail, Server, Shield, LogOut, Camera, Save, Key, Check } from 'lucide-react';
                ...
                <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-8">
                    <div className="flex justify-between items-center mb-6">
                        <h4 className="text-lg font-bold text-white flex items-center gap-2">
                            <Shield size={20} className="text-ocean-glow" /> Account Details
                        </h4>
                        <button 
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            <label className="block text-xs font-mono text-slate-500 mb-2 uppercase tracking-wider">Nextcloud Server URL</label>
                            <div className="flex items-center gap-3 bg-slate-950 border border-slate-800 rounded-lg p-3">
                                ...
                                <input 
                                    ...
                                    onChange={(e) => setProfile({...profile, serverUrl: e.target.value})}
                                    className="bg-transparent border-none outline-none text-ocean-glow w-full disabled:opacity-70"
                                />
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-8">
                     <div className="flex justify-between items-start mb-4">
                        <h5 className="text-lg font-bold text-white flex items-center gap-2">
                            <Key size={20} className="text-ocean-glow" /> Sicherheit
                        </h5>
                        {!showPasswordChange && (
                            <button 
