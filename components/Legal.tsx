        ...
        <section className="space-y-4">
          ...
          <div className="bg-slate-900/50 p-6 rounded-lg border border-slate-800 space-y-4">
            ...
            <div>
              ...
              <p>E-Mail: kontakt@fentarochen-project.de</p>
            </div>
            <div className="text-xs text-slate-500 italic mt-4">
              Hinweis: Dies ist ein fiktives Projekt-Impressum für die "FentaRochen" Web-Applikation.
            </div>
          </div>
        </section>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm leading-relaxed">
                    Diese Seite wird bei einem externen Dienstleister gehostet (z.B. Vercel/Netlify). 
