...
const LegalInfo: React.FC = () => {
  return (
    <div className="min-h-screen bg-black text-zinc-300 p-6 md:p-12 pt-32">
      <div className="max-w-3xl mx-auto space-y-12">
        ...
        <section className="space-y-4">
          ...
          <div className="bg-zinc-900/50 p-6 rounded-lg border border-zinc-800 space-y-4">
            <div>
              <h3 className="text-sm font-bold text-zinc-400 uppercase tracking-wider mb-1">Angaben gemäß § 5 TMG</h3>
              <p>Max Mustermann (Projektverantwortlicher)</p>
              <p>Musterstraße 123</p>
              <p>12345 Musterstadt</p>
            </div>
            <div>
              <h3 className="text-sm font-bold text-zinc-400 uppercase tracking-wider mb-1">Kontakt</h3>
              <p>Telefon: +49 (0) 123 445566</p>
              <p>E-Mail: kontakt@fentarochen.net</p>
            </div>
            <div className="text-xs text-zinc-500 italic mt-4">
          ...
          <div className="space-y-6">
            <div className="bg-zinc-900/50 p-6 rounded-lg border border-zinc-800">
              <div className="flex items-start gap-3">
                <Server className="mt-1 text-white flex-shrink-0" size={20} />
                <div>
            ...
            <div className="bg-zinc-900/50 p-6 rounded-lg border border-zinc-800 border-l-4 border-l-ocean-glow">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside text-sm space-y-2 text-zinc-400 ml-1">
                    <li>
                      <strong className="text-zinc-200">Datenübermittlung:</strong> Wenn Sie eine Nachricht in den Chat eingeben ("Comms") oder ein Bild generieren ("Vision"), wird Ihr Textinhalt an die Server von Google gesendet.
                    </li>
                    <li>
                      <strong className="text-zinc-200">Verarbeitung:</strong> Google verarbeitet diese Daten, um die Antwort zu generieren. Geben Sie keine persönlichen Daten (Namen, Adressen, Passwörter) in das Chat-Feld ein.
                    </li>
                    <li>
                      <strong className="text-zinc-200">Speicherung:</strong> Innerhalb dieser Web-Applikation werden Chat-Verläufe nur temporär im Arbeitsspeicher Ihres Browsers gehalten und beim Neuladen gelöscht (sofern nicht anders angegeben).
                    </li>
                  </ul>
